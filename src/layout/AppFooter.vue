    ...
    <footer class="footer has-cards">
        <div class="container">
            ...
            <div class="row align-items-center justify-content-md-between">
                <a href="#" target="_blank" class="footer-links">Disclaimer</a>
                <a href="#" target="_blank" class="footer-links">Privacy Policy</a>
                <a href="#" target="_blank" class="footer-links">Contact Us</a>
                <div class="col-md-12">
                    <div class="copyright">
                        &copy; 2019
                        <a href="#" target="_blank">Rainy Day</a>.
                    </div>
                </div>
            </div>
        </div>
